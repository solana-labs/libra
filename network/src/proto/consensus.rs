...
pub struct Proposal {
    ...
    pub timeout_quorum_cert: ::protobuf::SingularPtrField<PacemakerTimeoutCertificate>,
...
impl Proposal {
    ...
    // .network.PacemakerTimeoutCertificate timeout_quorum_cert = 3;


    pub fn get_timeout_quorum_cert(&self) -> &PacemakerTimeoutCertificate {
        self.timeout_quorum_cert.as_ref().unwrap_or_else(|| PacemakerTimeoutCertificate::default_instance())
    }
    pub fn clear_timeout_quorum_cert(&mut self) {
        self.timeout_quorum_cert.clear();
    }

    pub fn has_timeout_quorum_cert(&self) -> bool {
        self.timeout_quorum_cert.is_some()
    }

    // Param is passed by value, moved
    pub fn set_timeout_quorum_cert(&mut self, v: PacemakerTimeoutCertificate) {
        self.timeout_quorum_cert = ::protobuf::SingularPtrField::some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_timeout_quorum_cert(&mut self) -> &mut PacemakerTimeoutCertificate {
        if self.timeout_quorum_cert.is_none() {
            self.timeout_quorum_cert.set_default();
        }
        self.timeout_quorum_cert.as_mut().unwrap()
    }

    // Take field
    pub fn take_timeout_quorum_cert(&mut self) -> PacemakerTimeoutCertificate {
        self.timeout_quorum_cert.take().unwrap_or_else(|| PacemakerTimeoutCertificate::new())
    }

    // .network.QuorumCert highest_ledger_info = 4;
...
impl ::protobuf::Message for Proposal {
    fn is_initialized(&self) -> bool {
        ...
        for v in &self.timeout_quorum_cert {
            if !v.is_initialized() {
                return false;
            }
        };
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                3 => {
                    ::protobuf::rt::read_singular_message_into(wire_type, is, &mut self.timeout_quorum_cert)?;
                },
                4 => {
    ...
    fn compute_size(&self) -> u32 {
        ...
        if let Some(ref v) = self.timeout_quorum_cert.as_ref() {
            let len = v.compute_size();
            my_size += 1 + ::protobuf::rt::compute_raw_varint32_size(len) + len;
        }
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_singular_ptr_field_accessor::<_, ::protobuf::types::ProtobufTypeMessage<PacemakerTimeoutCertificate>>(
                    "timeout_quorum_cert",
                    |m: &Proposal| { &m.timeout_quorum_cert },
                    |m: &mut Proposal| { &mut m.timeout_quorum_cert },
                ));
                fields.push(::protobuf::reflect::accessor::make_singular_ptr_field_accessor::<_, ::protobuf::types::ProtobufTypeMessage<QuorumCert>>(
                    "highest_ledger_info",
                    |m: &Proposal| { &m.highest_ledger_info },
                    |m: &mut Proposal| { &mut m.highest_ledger_info },
                ));
...
impl TimeoutMsg {
    ...
    // .network.QuorumCert highest_ledger_info = 5;
...
impl ::protobuf::Message for TimeoutMsg {
    ...
    fn compute_size(&self) -> u32 {
        ...
        if !self.author.is_empty() {
            my_size += ::protobuf::rt::bytes_size(3, &self.author);
        }
        if !self.signature.is_empty() {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_singular_ptr_field_accessor::<_, ::protobuf::types::ProtobufTypeMessage<QuorumCert>>(
                    "highest_quorum_cert",
                    |m: &TimeoutMsg| { &m.highest_quorum_cert },
                    |m: &mut TimeoutMsg| { &mut m.highest_quorum_cert },
                ));
                ...
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeCarllercheBytes>(
                    "author",
                    |m: &TimeoutMsg| { &m.author },
                    |m: &mut TimeoutMsg| { &mut m.author },
                ));
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeCarllercheBytes>(
                    "signature",
                ...
                fields.push(::protobuf::reflect::accessor::make_singular_ptr_field_accessor::<_, ::protobuf::types::ProtobufTypeMessage<QuorumCert>>(
                    "highest_ledger_info",
                    |m: &TimeoutMsg| { &m.highest_ledger_info },
                    |m: &mut TimeoutMsg| { &mut m.highest_ledger_info },
                ));
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x01(\x0b2\x15.network.RespondChunkH\0R\x0crespondChunkB\t\n\x07message\
    \"\xf8\x01\n\x08Proposal\x125\n\x0eproposed_block\x18\x01\x20\x01(\x0b2\
    \x0e.network.BlockR\rproposedBlock\x12\x1a\n\x08proposer\x18\x02\x20\x01\
    (\x0cR\x08proposer\x12T\n\x13timeout_quorum_cert\x18\x03\x20\x01(\x0b2$.\
    network.PacemakerTimeoutCertificateR\x11timeoutQuorumCert\x12C\n\x13high\
    est_ledger_info\x18\x04\x20\x01(\x0b2\x13.network.QuorumCertR\x11highest\
    LedgerInfo\"^\n\x10PacemakerTimeout\x12\x14\n\x05round\x18\x01\x20\x01(\
    \x04R\x05round\x12\x16\n\x06author\x18\x02\x20\x01(\x0cR\x06author\x12\
    \x1c\n\tsignature\x18\x03\x20\x01(\x0cR\tsignature\"\x94\x02\n\nTimeoutM\
    sg\x12C\n\x13highest_quorum_cert\x18\x01\x20\x01(\x0b2\x13.network.Quoru\
    mCertR\x11highestQuorumCert\x12F\n\x11pacemaker_timeout\x18\x02\x20\x01(\
    \x0b2\x19.network.PacemakerTimeoutR\x10pacemakerTimeout\x12\x16\n\x06aut\
    hor\x18\x03\x20\x01(\x0cR\x06author\x12\x1c\n\tsignature\x18\x04\x20\x01\
    (\x0cR\tsignature\x12C\n\x13highest_ledger_info\x18\x05\x20\x01(\x0b2\
    \x13.network.QuorumCertR\x11highestLedgerInfo\"j\n\x1bPacemakerTimeoutCe\
    rtificate\x12\x14\n\x05round\x18\x01\x20\x01(\x04R\x05round\x125\n\x08ti\
    meouts\x18\x02\x20\x03(\x0b2\x19.network.PacemakerTimeoutR\x08timeouts\"\
    ...
    \x20\x01(\x0cR\tsignature\"\xc1\x01\n\nQuorumCert\x12\x19\n\x08block_id\
    ...
    ature\x18\x07\x20\x01(\x0cR\tsignature\"H\n\x0cRequestBlock\x12\x19\n\
    ...
    \x06blocks\x18\x02\x20\x03(\x0b2\x0e.network.BlockR\x06blocks\"\x7f\n\
    \x0cRequestChunk\x12#\n\rstart_version\x18\x01\x20\x01(\x04R\x0cstartVer\
    sion\x12+\n\x06target\x18\x02\x20\x01(\x0b2\x13.network.QuorumCertR\x06t\
    arget\x12\x1d\n\nbatch_size\x18\x03\x20\x01(\x04R\tbatchSize\"^\n\x0cRes\
    pondChunk\x12N\n\x13txn_list_with_proof\x18\x01\x20\x01(\x0b2\x1f.types.\
    TransactionListWithProofR\x10txnListWithProof*N\n\x14BlockRetrievalStatu\
